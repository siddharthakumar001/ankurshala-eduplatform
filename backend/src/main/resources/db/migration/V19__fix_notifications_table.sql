-- Fix notifications table to use VARCHAR instead of enum types
-- Drop existing table and recreate with VARCHAR columns

DROP TABLE IF EXISTS notifications CASCADE;
DROP TYPE IF EXISTS notification_audience CASCADE;
DROP TYPE IF EXISTS notification_delivery CASCADE;
